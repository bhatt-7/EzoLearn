...
function App() {
  ...
  return (
    <div className="w-screen min-h-screen bg-[#222629] flex flex-col font-inter ">
      <Navbar></Navbar>
      <Routes>
       ...
       <Route path="/payment" element={<BuyCoursePage/>}></Route>
        
       <Route path="/buy/:id" element={<BuyCoursePage />} />

        <Route path="/forgot-password" element={<OpenRoute><ForgotPass></ForgotPass></OpenRoute>}></Route>
